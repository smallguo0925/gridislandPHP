...
try {
    ...
    if (isset($_POST["prod_discount_price"]) && $_POST["prod_discount_price"] !== "") {
        // If 'prod_discount_price' exists and is not an empty string
        $prod->bindValue(":prod_discount_price", $_POST["prod_discount_price"], PDO::PARAM_INT);
    } else {
        // If 'prod_discount_price' does not exist or is an empty string, set it to NULL
